...
const CookieNotice = () => {
  ...
  useEffect(() => {
    import('./localStorageHandler').then(module => {
      const savedPreferences = JSON.parse(module.default.getItem('preferences'))
      if (savedPreferences) {
    ...
    <>
      ...
      {showPreferencesModal && (
        <div className='fixed inset-0 flex justify-center items-center bg-gray-800 bg-opacity-75 z-50'>
          <div className='bg-white p-6 rounded-lg max-w-xl' ref={modalRef}>
            <h2 className='text-lg font-semibold mb-4'>Manage Preferences</h2>
