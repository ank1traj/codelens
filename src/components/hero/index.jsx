        ...
        <div className='mx-auto max-w-2xl py-8 sm:py-48 lg:py-8'>
          <div className='hidden sm:mb-8 sm:flex sm:justify-center'>
            <div className='relative rounded-full px-3 py-1 text-sm leading-6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20'>
              Exciting News: Unveiling Our Revamped UI/UX Experience!{' '}
          ...
          <div className='text-center'>
            ...
            <p className='mt-3 text-lg leading-8 text-gray-500'>
              CodeLens is a comprehensive platform designed to elevate your
              competitive programming experience. With a suite of powerful tools
              at your disposal, including test case generation, constraint
              validation, solution optimization, code coverage analysis, and
              automated evaluation, CodeLens enables you to delve deep into your
              code, uncover insights, and enhance your problem-solving skills.
            </p>
