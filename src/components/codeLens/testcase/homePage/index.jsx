          ...
          >
            ...
            >
              <div className='flex items-center justify-center'>
                <link.iconType className={`w-8 h-8 ${link.iconColor}`} />
              </div>
      ...
      <div className='iconInfo flex items-center justify-center mt-8'>
        <ul className='flex items-center justify-between w-full'>
          <li className='flex items-center'>
            <CheckCircleIcon style={{ color: 'green' }} className='w-8 h-8' />
            <span className='iconLabel text-xs ml-2'>Completed</span>
          </li>
          <li className='flex items-center px-8'>
            <ExclamationCircleIcon
              ...
              className='w-8 h-8'
            />
            <span className='iconLabel text-xs ml-2'>Not Started yet</span>
          </li>
          <li className='flex items-center px-8'>
            <ArrowUpOnSquareIcon
              style={{ color: 'green' }}
              className='w-8 h-8'
            />
            <span className='iconLabel text-xs ml-2'>In Progress</span>
          </li>
          <li className='flex items-center px-8'>
            <ForwardIcon style={{ color: 'blue' }} className='w-8 h-8' />
